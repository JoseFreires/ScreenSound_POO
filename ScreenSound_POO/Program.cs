...
void AvaliarUmaArtista()
{
    ...
    if (artistasRegistrados.ContainsKey(nomeDaArtista))
    {
        ...
        Console.Write($"Qual a nota que a banda {nomeDaArtista} merece: ");
        Avaliacao nota = Avaliacao.Parse(Console.ReadLine()!);
        artista.AdicionarNota(nota);
        Console.WriteLine($"\nA nota {nota.Nota} foi registrada com sucesso para a banda {nomeDaArtista}");
        Thread.Sleep(2000);
        Console.Clear();
        ExibirOpcoesDoMenu();
    }
